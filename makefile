...
EXAMPLESOBJS=Queue.o main.o Generator.o Walk_No_But_Sen.o Walk_But_Sen.o Sensor.o Button.o Light.o distri.o com.o linpack.o debug.o register.o
LIBNAME=simu
LIBS=-lsimu
...
Walk_No_But_Sen.o: Walk_No_But_Sen.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<

Walk_But_Sen.o: Walk_But_Sen.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<
